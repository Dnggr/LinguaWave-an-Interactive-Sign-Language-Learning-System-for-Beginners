...
function updateLessonMeta() {
  ...
  // Back link returns to this sign's own V2 Mission Overview page
  // (v2-mission-overview.html reads the same ?mission= param
  // v2-mission-overview.js's own links use) — the V2 equivalent of
  // what this link used to send back to on V1's learn.html grid.
  // 'fingerspell_name' has a real mission entry too (dataV2 covers
  ...
  if (backBtnEl) {
    backBtnEl.href = `v2-mission-overview.html?mission=${encodeURIComponent(category)}`;
  }
